<?php
	...
	if( function_exists('acf_add_local_field_group') ):
		...
		acf_add_local_field_group(array(
			'key' => 'group_5be66a9b6d23d',
			'title' => 'Banner Options',
			'fields' => array(
				array(
					'key' => 'field_5be66abee4084',
					'label' => 'Banner Content',
					'name' => 'zerofour_banner_content',
					'type' => 'wysiwyg',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
		...
		acf_add_local_field_group(array(
			'key' => 'group_5be6a2f716740',
			'title' => 'Featured Post Option',
			'fields' => array(
				array(
					'key' => 'field_5be6a30475724',
					'label' => 'Set Featured Post',
					'name' => 'zerofour_featured_post',
					'type' => 'true_false',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
		...
		acf_add_local_field_group(array(
			'key' => 'group_5be682c9eda46',
			'title' => 'Post Icon',
			'fields' => array(
				array(
					'key' => 'field_5be682e3ef221',
					'label' => 'Select Icon',
					'name' => 'zerofour_services_post_icons',
					'type' => 'font-awesome',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
		...
		acf_add_local_field_group(array(
			'key' => 'group_5be6abff2ae50',
			'title' => 'Recent Posts Options',
			'fields' => array(
				array(
					'key' => 'field_5be6ac17c72e5',
					'label' => 'Recent Posts Section Title',
					'name' => 'zerofour_recent_posts_section_title',
					'type' => 'text',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
					...
					'default_value' => '',
					'placeholder' => 'Leave empty to show "Recent Posts"',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
				),
				array(
					'key' => 'field_5be6adb5142f8',
					'label' => 'Show Posts Per Page',
					'name' => 'zerofour_latest_show_posts_per_page',
					'type' => 'range',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array(
					'key' => 'field_5be6b941763e6',
					'label' => 'Show Sidebar',
					'name' => 'zerofour_rec_posts_show_sidebar',
					'type' => 'true_false',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array(
					'key' => 'field_5be6b97f763e7',
					'label' => 'Show Spotlight Post',
					'name' => 'zerofour_show_spotlight_post',
					'type' => 'true_false',
					'instructions' => '',
					'required' => 0,
				...
				array(
					'key' => 'field_5be6bc0f3ea86',
					'label' => 'Spotlight Post Section Title',
					'name' => 'zerofour_spotlight_post_section_title',
					'type' => 'text',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => array(
					...
					'default_value' => '',
					'placeholder' => 'Leave empty to show "Spotlight"',
					'prepend' => '',
					'append' => '',
					'maxlength' => '',
				),
				array(
					'key' => 'field_5be6bcc059c3c',
					'label' => 'Select Spotlight Post',
					'name' => 'zerofour_select_spotlight_post',
					'type' => 'post_object',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => array(
		...
		acf_add_local_field_group(array(
			'key' => 'group_5be66f3c0f13e',
			'title' => 'Services Options',
			'fields' => array(
				array(
					'key' => 'field_5be6716a63878',
					'label' => 'Services Section Heading',
					'name' => 'zerofour_services_section_heading',
					'type' => 'text',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array(
					'key' => 'field_5be6721163879',
					'label' => 'Services Section Sub Heading',
					'name' => 'zerofour_services_section_sub_heading',
					'type' => 'text',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array(
					'key' => 'field_5be672e59ac05',
					'label' => 'Show Posts Per Page',
					'name' => 'zerofour_show_posts_per_page',
					'type' => 'range',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
				...
				array(
					'key' => 'field_5be672286387a',
					'label' => 'Services Section Descriptions',
					'name' => 'zerofour_services_section_descriptions',
					'type' => 'wysiwyg',
					'instructions' => '',
					'required' => 0,
					'conditional_logic' => 0,
